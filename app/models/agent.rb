...
class Agent < SystemUser
	...
	validates :type, presence: true, inclusion: {in: ['Agent'], message: "%{value} is not a correct type"}

	belongs_to :property_manager, class_name: "PropertyManager"
