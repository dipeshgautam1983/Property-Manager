...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { apartmentnumber: @apartment.apartmentnumber, apartmenttype: @apartment.apartmenttype, status: @apartment.status }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { apartmentnumber: @apartment.apartmentnumber, apartmenttype: @apartment.apartmenttype, status: @apartment.status }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
